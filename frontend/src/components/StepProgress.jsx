  ...
  return (
    <>
      ...
      <div className="relative w-full h-4 bg-white/5 backdrop-blur-2xl overflow-hidden rounded-full border border-white/10">
        ...
        <div
          className="relative h-full bg-gradient-to-r from-teal-500 via-amber-500 to-teal-600 animate-flow bg-[length:200%_100%] transition-all duration-700 ease-out rounded-full overflow-hidden animate-pulse-glow"
